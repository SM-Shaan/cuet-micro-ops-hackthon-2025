    ...
    <div className="card">
      ...
      <div className="grid grid-cols-2 gap-4">
        {metrics.map((metric) => (
          ...
          >
            <div
              className={`w-10 h-10 mx-auto mb-3 rounded-xl bg-gradient-to-br ${metric.color} flex items-center justify-center shadow-lg transition-transform group-hover:scale-110`}
            >
              <svg
                className="w-5 h-5 text-white"
                fill="none"
