...
export function PerformanceMetrics() {
  ...
  useEffect(() => {
    const updateMetrics = (event: CustomEvent<{ type: string; value: number }>) => {
    ...
    return () => {
      window.removeEventListener('metricUpdate', updateMetrics as EventListener);
    };
  }, []);
