...
# ... (more security header tests)
#
# === Download Initiate Endpoint ===
# ✓ PASS: Download initiate returns jobId
# ✓ PASS: Download initiate status is queued
# ✓ PASS: Download initiate totalFileIds is correct
#
# === Download Check Endpoint ===
# ✓ PASS: Download check returns correct file_id
# ✓ PASS: Download check returns available field
#
# === Test Summary ===
# Passed: X | Failed: 0
```
